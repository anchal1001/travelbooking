...
<body onload="resetForm()">
    ...
    <div>
        ...
        <p>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidatorPhone" runat="server"  controltovalidate="tbxPhone" ValidateExpression="[0-9]{10}" ErrorMessage="Enter a valid phone number" ForeColor="red"></asp:RegularExpressionValidator>
        </p>
        <p>
