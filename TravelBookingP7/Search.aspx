...
<body>
          ...
          <button class="btn"><a href="Home.aspx" style="color:darkgrey;text-decoration:none">Home</a></button>
           <asp:GridView ID="GridViewData" runat="server" AllowPaging="False" AutoGenerateColumns="false" >
            <Columns>
                                   <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lbEdit" CommandArgument='<%# Eval("Id") %>' runat="server" CommandName="Visit" Text="Visit" href="../Explore.aspx">
                            </asp:LinkButton>
                        </ItemTemplate>
     ...
     <asp:TemplateField HeaderText="City Id">
                        <EditItemTemplate>
                            <asp:TextBox ID="tbxCityId" runat="server" Text='<%# Eval("Id") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblCityId" runat="server" Text='<%# Eval("Id") %>'></asp:Label>
                        </ItemTemplate>
     </asp:TemplateField>
