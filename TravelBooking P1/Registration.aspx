...
<body onload="resetForm()">
    ...
    <div>
        ...
        <p>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidatorRoles" runat="server" controltovalidate="tbxPassword" ErrorMessage="Role is required" ForeColor="red"></asp:RequiredFieldValidator>
        </p>
        <p>
