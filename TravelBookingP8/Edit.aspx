...
<body>
    ...
    <article>
        <p><a href="#" onserverclick="goBack">Go back</a></p>
    </article>
    <div class="bar">
        <nav class="left">
            <p>Navigate to...</p>
            <ul class="list1">
                <li><a href="home2.apsx" runat="server" >Home</a></li>
            ...
            <div class="wrapper">
                <table class="journey">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="tbxDateOfJourney" type="date" AutoPostBack="True" OnTextChanged="tbxDateOfJourney_TextChanged"></asp:TextBox></td>
                        <td><asp:Label id="lblstartDate" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="label">Select return date</td>
                        <td>
                            <asp:TextBox runat="server" ID="tbxReturnDate" type="date" OnTextChanged="tbxReturnDate_TextChanged"></asp:TextBox></td>
...
<%--                            <asp:RadioButtonList ID="rblMode"  validationgroup="Details" runat="server">
          ...
          <input class="radio" id="rbtCar" name="chooseone" type="radio" value="car">Car--%>
                             <asp:RadioButton runat="server" ID="rbtnTrain" value="1" Text="Train" GroupName="Mode"/>
                            <asp:RadioButton runat="server" ID="rbtnBus" value="2" Text="Bus" GroupName="Mode"/>
                            <asp:RadioButton runat="server" ID="rbtnCar" value="3" Text="Car" GroupName="Mode"/>
                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           <td> <asp:Button id="btnDelete" runat="server" OnClick="Delete_Click" Text="Delete"></asp:Button></td>
                    </tr>
                </table>
